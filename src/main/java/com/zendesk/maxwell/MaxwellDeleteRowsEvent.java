...
public class MaxwellDeleteRowsEvent extends MaxwellAbstractRowsEvent {
	...
	public MaxwellDeleteRowsEvent(DeleteRowsEvent e, Table table, MaxwellFilter f, boolean omitNulls) {
		super(e, table, f, omitNulls);
		this.event = e;
	}

	public MaxwellDeleteRowsEvent(DeleteRowsEventV2 e2, Table table, MaxwellFilter filter, boolean omitNulls) {
		super(e2, table, filter, omitNulls);
